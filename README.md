...
| [snowdag](https://github.com/MiguelElGallo/snowdag) | Airflow dbt Snowpark orchestration | - | - | ✅ | - |
...
| [dlthubsnow](https://github.com/MiguelElGallo/dlthubsnow) | dlt in Snowpark Container Services | dlt, requests | - | ✅ | - |
| [Arrow_as_source](https://github.com/MiguelElGallo/Arrow_as_source) | Apache Arrow universal dataset demo | arrow, duckdb, polars, pyarrow | - | ✅ | - |
| [ghs](https://github.com/MiguelElGallo/ghs) | GitHub variables sync utility | pydantic, python-dotenv, typer | - | - | - |
| [myfirstmcp-openai](https://github.com/MiguelElGallo/myfirstmcp-openai) | FastMCP on Azure App Service | mcp, gunicorn, uvicorn | App Service | - | ✅ |
| [CallAPIfromLLM](https://github.com/MiguelElGallo/CallAPIfromLLM) | LLM function calling demonstration | - | - | - | ✅ |
| [homebrew-iparq](https://github.com/MiguelElGallo/homebrew-iparq) | Homebrew tap for iparq | - | - | - | - |
| [snowtofu](https://github.com/MiguelElGallo/snowtofu) | Snowflake IaC with OpenTofu | - | Storage Account | ✅ | - |
| [simple-fastapi-snow-azd](https://github.com/MiguelElGallo/simple-fastapi-snow-azd) | FastAPI with Snowflake pagination | fastapi, snowflake-sqlalchemy | Functions | ✅ | - |
...
| [Modelando2025](https://github.com/MiguelElGallo/Modelando2025) | Data modeling concepts 2025 | mkdocs-material, mkdocs-i18n | - | ✅ | - |
| [dltHub-teesting](https://github.com/MiguelElGallo/dltHub-teesting) | dlt testing framework | dlt, duckdb, pytest | - | ✅ | - |
| [ChartToMD](https://github.com/MiguelElGallo/ChartToMD) | Chart to markdown RAG converter | aiohttp, azure-identity, pydantic, typer | - | - | ✅ |
| [SnowCLI](https://github.com/MiguelElGallo/SnowCLI) | Snowflake CLI GitHub Actions | - | - | ✅ | - |
| [rag-graph](https://github.com/MiguelElGallo/rag-graph) | Graph approaches for RAG | - | - | - | ✅ |
| [opeanai-rag-test](https://github.com/MiguelElGallo/opeanai-rag-test) | OpenAI RAG Spanish document test | openai, python-dotenv | - | - | ✅ |
| [ragvectordb](https://github.com/MiguelElGallo/ragvectordb) | Multi-vector database RAG | - | AI Search | ✅ | ✅ |
| [azdcodespaces](https://github.com/MiguelElGallo/azdcodespaces) | Azure Developer CLI Codespaces | - | - | - | - |
| [azureaisearch](https://github.com/MiguelElGallo/azureaisearch) | Azure AI Search with embeddings | - | AI Search | - | ✅ |
| [azopenai_adx](https://github.com/MiguelElGallo/azopenai_adx) | ADX for embeddings storage | - | Data Explorer | ✅ | ✅ |
